...
int main() {
    ...
    testTransliteratorWithRules("中文", "NFKD; [:Nonspacing Mark:] Remove; Traditional-Simplified; Lower", "Chinese (zh)");
    testTransliteratorWithRules("日本語", "NFKD; [:Nonspacing Mark:] Remove; Katakana-Hiragana; Lower", "Japanese (ja)");
    testTransliteratorWithRules("ภาษาไทย", "NFKD; [:Nonspacing Mark:] Remove; Lower", "Thai (th)");
    testTransliteratorWithRules("한국어", "NFKD; [:Nonspacing Mark:] Remove; Lower", "Korean (ko)");
    testTransliteratorWithRules("العربية", "NFKD; [:Nonspacing Mark:] Remove; Arabic-Latin; Lower", "Arabic (ar)");
    testTransliteratorWithRules("русский", "NFKD; [:Nonspacing Mark:] Remove; Cyrillic-Latin; Lower", "Russian (ru)");
    testTransliteratorWithRules("עברית", "NFKD; [:Nonspacing Mark:] Remove; Hebrew-Latin; Lower", "Hebrew (he)");
    testTransliteratorWithRules("Ελληνικά", "NFKD; [:Nonspacing Mark:] Remove; Greek-Latin; Lower", "Greek (el)");
    testTransliteratorWithRules("Français", "NFKD; [:Nonspacing Mark:] Remove; Latin-ASCII; Lower", "French (fr)");
