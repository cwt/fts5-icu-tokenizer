/**
 * @file fts5_icu_v1.h
 * @brief Definitions and type definitions for ICU-based FTS5 tokenizer (Legacy API v1)
 *
 * This header file provides all the necessary definitions, constants, and
 * data structures for the ICU-based FTS5 tokenizer using the legacy API v1.
 * It includes locale-specific configuration and ICU rule definitions.
 */

#ifndef FTS5_ICU_V1_H
#define FTS5_ICU_V1_H
